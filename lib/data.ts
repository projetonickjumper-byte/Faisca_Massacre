...
export const categories: Category[] = [
  ...
  { id: "5", name: "Dancas", slug: "dancas", icon: "music", count: 45 },
...
export const banners: Banner[] = [
  {
    ...
    title: "Primeira aula gratis",
    subtitle: "Experimente a melhor academia da regiao",
  ...
  },
  {
    ...
    subtitle: "Aproveite essa promocao por tempo limitado",
  ...
  },
  {
    ...
    subtitle: "Participe e ganhe premios incriveis",
...
export const gyms: Gym[] = [
  {
    ...
    description: "A SmartFit Paulista oferece estrutura completa para seu treino, com equipamentos de ultima geracao, aulas coletivas variadas e ambiente climatizado. Nossa equipe de profissionais esta sempre pronta para ajudar voce a alcancar seus objetivos.",
    ...
    totalReviews: 1248,
    totalCheckins: 45820,
    modalities: ["Musculacao", "Cardio", "Funcional", "Spinning", "Yoga", "Pilates"],
    amenities: ["Ar condicionado", "Vestiarios", "Armarios", "Estacionamento", "Wi-Fi", "Agua gratuita"],
    openingHours: {
    ...
    plans: [
      ...
      },
      {
        ...
        price: 99.9,
        originalPrice: 119.9,
        features: ["Acesso ilimitado", "Todas as modalidades", "App exclusivo", "1 avalicao fisica"],
        popular: true,
      },
      {
        id: "p3",
        ...
        price: 79.9,
        originalPrice: 119.9,
        features: ["Acesso ilimitado", "Todas as modalidades", "App exclusivo", "4 avaliacoes fisicas", "Personal 1x/mes"],
        hasFreeTrial: true,
        trialDays: 7,
      },
    ],
    dayUse: {
      ...
      cancellationPolicy: "Cancelamento gratuito ate 2h antes",
    },
    acceptsWellhub: true,
  ...
  },
  {
    ...
    name: "BlueFit Moema",
    slug: "bluefit-moema",
    description: "A BlueFit Moema e referencia em treino funcional e crossfit na zona sul de Sao Paulo. Ambiente moderno, equipamentos importados e treinadores certificados internacionalmente.",
    ...
    totalReviews: 892,
    totalCheckins: 32150,
    modalities: ["Crossfit", "Funcional", "HIIT", "Levantamento olimpico"],
    amenities: ["Ar condicionado", "Vestiarios", "Estacionamento", "Loja", "Cafe"],
    openingHours: {
  ...
  },
  {
    ...
    amenities: ["Ar condicionado", "Vestiarios", "Armarios", "Loja"],
    openingHours: {
    ...
    plans: [
      ...
      },
      {
        ...
        price: 189.9,
        originalPrice: 249.9,
        features: ["Acesso ilimitado", "Todos os WODs", "Acompanhamento", "Competicoes internas"],
        popular: true,
      },
    ],
    dayUse: null,
  ...
  },
  {
    ...
    amenities: ["Ar condicionado", "Vestiarios", "Agua", "Estacionamento"],
    openingHours: {
    ...
    plans: [
      ...
      },
      {
        ...
        price: 580,
        originalPrice: 640,
        features: ["8 aulas mensais", "Aulas individuais ou dupla", "Horario flexivel"],
        popular: true,
      },
    ],
    dayUse: {
      ...
      cancellationPolicy: "Cancelamento ate 24h antes",
    },
    acceptsWellhub: false,
    acceptsTotalPass: false,
    hasFreeTrial: true,
...
export const reviews: Review[] = [
  {
    ...
    userLevel: 12,
    rating: 5,
    text: "Excelente academia! Equipamentos sempre em otimo estado, ambiente limpo e profissionais muito atenciosos. Frequento ha 2 anos e recomendo muito.",
    images: ["https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400&h=300&fit=crop"],
    date: "2026-01-15",
    helpful: 24,
    modality: "Musculacao",
    gymResponse: {
      text: "Obrigado pelo feedback, Carlos! Ficamos felizes em ter voce como aluno. Conte sempre conosco!",
      date: "2026-01-16",
    },
  },
  {
    ...
    userLevel: 8,
    rating: 4,
    text: "Otima estrutura e boas aulas de spinning. Unico ponto negativo e que fica lotado no horario de pico.",
    date: "2026-01-10",
    helpful: 12,
    modality: "Spinning",
  },
  {
    ...
    userLevel: 15,
    rating: 5,
    text: "Melhor academia que ja frequentei. As aulas de funcional sao incriveis e os instrutores muito capacitados.",
    date: "2026-01-05",
    helpful: 18,
    modality: "Funcional",
  },
...
export const fitRankEntries: FitRankEntry[] = [
  ...
  { position: 6, userId: "u1", userName: "Voce", userAvatar: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=100&h=100&fit=crop&crop=face", points: 1240, checkins: 15, streak: 7 },
]
...
export const gymProducts: GymProduct[] = [
  ...
  },
  {
    ...
    description: "Garrafa termica de 1 litro, mantem temperatura por 12h.",
    price: 59.9,
  ...
  },
  {
    ...
    description: "Luva profissional para musculacao com suporte de punho.",
    price: 89.9,
...
export const currentUser: User = {
  ...
  bio: "Apaixonado por musculacao e crossfit. Treinando desde 2020.",
...
export const achievements: Achievement[] = [
  {
    ...
    description: "Faca seu primeiro check-in em uma academia",
    icon: "check-circle",
  ...
  },
  {
    id: "a4",
    name: "Avaliador",
    description: "Escreva sua primeira avaliacao",
    icon: "star",
    unlockedAt: "2024-08-15",
    xpReward: 75,
    requirement: "1 avaliacao",
  },
  {
    id: "a5",
    name: "Explorador",
...
export const personalTrainers: PersonalTrainer[] = [
  {
    ...
    specialties: ["Musculacao", "Emagrecimento", "Hipertrofia"],
    rating: 4.9,
    totalReviews: 87,
    pricePerHour: 120,
    bio: "Personal trainer certificado CREF com 8 anos de experiencia. Especialista em transformacao corporal.",
  ...
  },
  {
    ...
    totalReviews: 64,
    pricePerHour: 150,
    bio: "Especialista em treinamento funcional e pilates. Trabalho com gestantes e pos-parto.",
